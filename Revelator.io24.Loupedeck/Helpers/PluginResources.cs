namespace Loupedeck.RevelatorIo24Plugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.RevelatorIo24Plugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.RevelatorIo24Plugin.Resources.Resource.txt`.
